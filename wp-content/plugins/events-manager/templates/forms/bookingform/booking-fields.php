...
<?php if( !is_user_logged_in() && apply_filters('em_booking_form_show_register_form',true) ): ?>
	...
	<p>
		...
		<input type="text" required="true" name="user_name" id="user_name" class="input" value="<?php if(!empty($_REQUEST['user_name'])) echo esc_attr($_REQUEST['user_name']); ?>" />
	</p>
	<p>
...
<?php endif; ?>		
<p>
	<label for='booking_comment'>Message</label>
